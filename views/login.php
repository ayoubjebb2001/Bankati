...
?>
<div class="flex justify-center items-center bg-gray-100 font-[sans-serif] h-full md:max-h-screen p-4">
  <div class="grid justify-center max-w-md mx-auto">
    <div>
      <img src="https://readymadeui.com/login-image.webp" class="w-full object-cover rounded-2xl" alt="login-image" />
    </div>

    <form method="post" action="/signin" class="bg-white rounded-2xl p-6 -mt-24 relative z-10 shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)]">
      <div class="mb-12">
